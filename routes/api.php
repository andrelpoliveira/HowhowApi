...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::group(['prefix' => 'userUpdate'], function () {
        Route::post('/influencer',     [UserController::class, 'updateInfluencer']);
        Route::post('/brand',          [UserController::class, 'updateBrand']);
        Route::post('/agency',         [UserController::class, 'updateAgency']);
    });
